...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      console.log('Sending registration request to: http://192.168.33.10:3001/api/auth/register')
      const response = await fetch('http://192.168.33.10:3001/api/auth/register', {
        method: 'POST',
        headers: {
